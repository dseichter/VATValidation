...
class MainFrame(wx.Frame):
    ...
    def __init__(self, parent):
        ...
        self.staticTextURL = wx.StaticText(self.panelConfig, wx.ID_ANY, _(u"VATValidation URL"), wx.DefaultPosition, wx.DefaultSize, 0)
...
class dialogAbout(wx.Dialog):
    ...
    def __init__(self, parent):
        wx.Dialog.__init__(self, parent, id=wx.ID_ANY, title=_(u"About VATValidation"), pos=wx.DefaultPosition, size=wx.DefaultSize, style=wx.DEFAULT_DIALOG_STYLE)
