...
Validierung von Umsatzsteuernummern über die Schnittstellen von VIES und/oder HMRC. Bietet Einzel- oder Batch-Validierung mit Unterstützung für CSV, XLSX und JSON.
